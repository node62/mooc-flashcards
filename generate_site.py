...
<body class="bg-gray-900 text-gray-200 flex h-full">
    ...
    <main class="w-full flex-grow flex flex-col items-center justify-center p-4 sm:p-6 lg:ml-64">
        ...
        <div class="w-full max-w-3xl">
            ...
            <div id="card-container" class="hidden bg-gray-800 rounded-xl shadow-2xl p-6 sm:p-8 flex flex-col justify-center items-start text-left w-full h-[65vh] max-h-[500px] overflow-y-auto">
                <p id="question-area" class="text-lg sm:text-xl md:text-2xl leading-relaxed"></p>
    ...
    <!-- Cram Progress Bar -->
    <div id="cram-progress-bar-container" class="hidden fixed bottom-0 left-0 right-0 z-10 p-4 lg:ml-64">
        <div id="cram-progress-bar" class="w-full h-2.5 rounded-full bg-gray-700 flex overflow-hidden">
            <!-- Segments will be added here -->
        </div>
    </div>

    <!-- Cram Mode Modal -->
    <div id="cram-modal" class="hidden fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-40">
    ...
    <script>
        ...
        const cramProgressBarContainer = document.getElementById('cram-progress-bar-container');
        ...
        function showDeckCard(index) {
            ...
            cardContainer.scrollTop = 0; // Scroll to top for new card
        }
        ...
        function startCramSession() {
            ...
            cramProgressBarContainer.classList.remove('hidden');
        ...
        function exitCramMode() {
            ...
            cramProgressBarContainer.classList.add('hidden');
