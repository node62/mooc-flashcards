            ...
            <div id="cram-controls" class="hidden mt-6 flex-col items-center">
                <div class="flex justify-center items-center space-x-4">
                 ...
                 <div id="cram-feedback" class="hidden mt-4 flex justify-center items-center space-x-2 md:space-x-4">
                    ...
                    <button data-difficulty="mid" class="cram-feedback-btn bg-yellow-500 hover:bg-yellow-400 text-white font-bold py-3 px-4 sm:px-6 rounded-lg transition-colors text-sm sm:text-base">Mid</button>
