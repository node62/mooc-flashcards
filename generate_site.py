...
<body class="bg-gray-900 text-gray-200 flex h-full">
    ...
    <main class="flex-grow flex flex-col items-center justify-center p-6">
        <div class="w-full max-w-3xl">
            ...
            <!-- Flashcard Area -->
            <div id="card-container" class="hidden bg-gray-800 rounded-xl shadow-2xl p-8 flex flex-col justify-center items-center text-center w-full h-96 min-h-[24rem]">
